package com.luokine.common.orm.provider.insert;
 ...
 */
public class InsertListExtraProvider extends MapperTemplate {

    public InsertListExtraProvider(Class<?> mapperClass, MapperHelper mapperHelper) {
